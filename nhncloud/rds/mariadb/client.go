...
func (c *Client) initHTTPClient() {
	baseURL := endpoint.ResolveWithAppKey(endpoint.ServiceRDSMariaDB, c.region, c.appKey)
...
func (c *Client) EnableHA(ctx context.Context, instanceID string, pingInterval, failoverWaitTime int) (*JobOutput, error) {
	req := map[string]interface{}{
		"useHighAvailability":     true,
		"pingInterval":            pingInterval,
		"failoverReplWaitingTime": failoverWaitTime,
	}
	var out JobOutput
